...
# Para hacer Levene tenes que tener replicas
...
## existrelacion lineal entre DBO y pH? 
# Síiiii,porque nos dio significativa la interaccion. Ya sabemos entonces que hubo relacion lineal
# difiere entre las fuentes?
# siiiii
...
##  DBO = 39.4+40.3*ph-306*FuenteB-197.7*FuenteC+31.0*ph*fuenteB+13.6*ph*fuenteC


##DBOFUENTEA=39.42+40.26ph

##DBOFuenteB=-267.01(39-306)+71.21pH
#intercept dbo promedio para ph0

##DBOFuenteC=-158(39-197)+53.82(40.26+13.56).ph
...
# Existen diferencias significativas entre las pendientes muestrales de las fuentes A y B ya que no se ve
# superposicion de las flechas rojas
...
# cambian los beta de fuente b yfuente c y la intercept. No cambia la interaacion ni el ph
# comparacion de DBO media del agua de las 3 fuentes para un valor de pH promedio
